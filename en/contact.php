            ...
            <div id="centercontent" class="center-content">
                <div class="inner-content contact">
                    <div class="left" style="padding-right: 40px;">
                        ...
                        <h4><span class="label">Contact</span></h4>
                            ...
                            <?php 
                                if (isset($config->Contact)) {
                                    ...
                                    foreach ($config->Contact->Url as $contacturl) {
                                        ...
                                        print '<li>Homepage: <a href="http://'.$contacturl.'"'.$urlitemprop.'>'.$contacturl.'</a></li>';
                                        $i++;
                                    }
                                    ...
                                    print '<li itemprop="postal-code">'.$config->Contact->ZIP.'</li>';
                                    print '<li style="padding-bottom: 10px;" itemprop="country-name">'.$config->Contact->Country.'</li>';
                                    print '</ul>';
                                }
                            ?>
                        </div>
